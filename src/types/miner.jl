...
#### this was used after anchored_semantics wrapper, which returns many miners;
#### instead of wasting computational resources, there is no problem in keeping such objects
#### separated.
####
#### """
