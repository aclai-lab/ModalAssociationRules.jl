# This was an old set of utilities to help the user define an alphabet of motifs, that is,
# to create an alphabet of atoms wrapping ScalarCondition(VariableDistance, <=, threshold).
#
# Now, this can be simplified a lot; see `label_motifs` in the experiments folder
