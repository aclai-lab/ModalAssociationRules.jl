...
You can execute the experiments by running the `natops.ipynb` notebook.
...
Note that you can create your own serialized motifs, executing `label_motifs` as indicated in the aforementioned notebook.

`motifs-plotter.jl` is an utility script needed for plotting all the serialized motifs.